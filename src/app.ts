...
export default class App {
  ...
  constructor() {
    ...
    this.next = 'https://graph.facebook.com/v13.0/pages/search?access_token=EAABsbCS1iHgBABeqwRb0CDiDAdB1PUHqyZCVRcuHGbP0S27AqFnqRyDZCh2K0J3ZAgvAvkllW7OI1ZCxi0SaIG4meZAexubzJ4aIgB2rlRao2lvZCNhmYB5KwZBQzw1D79LqiCKHLe6rAZCWuGX6D3cgCAgi7eIt2oTmjw8woVwpdYG4yh7CXR8MFkrSiegTHX4ZD&__cppo=1&debug=all&format=json&method=get&pretty=0&q=nails&state=%22united%20state%22&suppress_http_code=1&transport=cors&type=country'
  }
    ...
    console.log(`🛠 LOG: 🚀 --> -------------------------------------------------------------------------------`);
     ...
     tr.request(this.next, {
      headers: {
        ...
        'Cookie': 'usida=eyJ2ZXIiOjEsImlkIjoiQXJjd2pncjFubzk0ZW0iLCJ0aW1lIjoxNjU0MjYwOTA2fQ%3D%3D; wd=1650x404; cppo=1; c_user=100066192924982; fr=0XFKI17wpVlV75XcS.AWU5tBMU1xV4g9f_wrwDZwHoEYY.BimgLJ.ZU.AAA.0.0.BimgLJ.AWVPPRruYRc; xs=38%3AbwcltOQYQGvyxA%3A2%3A1654260359%3A-1%3A14128%3A%3AAcUv80i1oWm0RJIa2Im0qQhhxRhcgC_rkglqQqFpdA; sb=fRZdYmmkyLCqUiLG_yqHqUa2; dpr=2; datr=fRZdYvFPptvdypB4vUSP-Iy_',
      ...
      console.log(`🛠 LOG: 🚀 --> -------------------------------------------------------------------🛠 LOG: 🚀 -->`);
      console.log(`🛠 LOG: 🚀 --> ~ file: app.ts ~ line 85 ~ App ~ getData= ~ res`, res);
      console.log(`🛠 LOG: 🚀 --> -------------------------------------------------------------------🛠 LOG: 🚀 -->`);
      const data = JSON.parse(res.body);
      console.log(`🛠 LOG: 🚀 --> ---------------------------------------------------------------------🛠 LOG: 🚀 -->`);
      console.log(`🛠 LOG: 🚀 --> ~ file: app.ts ~ line 89 ~ App ~ getData= ~ data`, data);
      console.log(`🛠 LOG: 🚀 --> ---------------------------------------------------------------------🛠 LOG: 🚀 -->`);
      const records: any[] = [];
