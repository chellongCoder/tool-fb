...
const getData = async (limit: number, resolve?: any, ) => {
  tr.request({
    ...
    // await Promise.all(res.data.data.map(async (element: any, index:number) => {
